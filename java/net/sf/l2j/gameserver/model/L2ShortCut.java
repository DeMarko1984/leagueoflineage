...
public class L2ShortCut
{
	 ...
	 * @param skillLevel
	 */
	public L2ShortCut(L2ShortCut l2ShortCut, int skillLevel)
	{
		_slot = l2ShortCut.getSlot();
		_page = l2ShortCut.getPage();
		_type = l2ShortCut.getType();
		_id = l2ShortCut.getId();
		_level = skillLevel;
	}
	...
	{
		return "L2ShortCut [_slot=" + _slot + ", _page=" + _page + ", _type=" + _type + ", _id=" + _id + ", _level=" + _level + "]";
	}
