...
public final class L2Augmentation
{
	...
	private void saveAugmentationData()
	{
		ThreadPoolManager.getInstance().executeTask(() ->
		{
			...
			{
				_log.log(Level.SEVERE, "Could not save augmentation for item: " + _item.getObjectId() + " from DB:", e1);
			}
			finally
			{
				try
	...
	public void deleteAugmentationData()
	{
		...
		ThreadPoolManager.getInstance().executeTask(() ->
		{
			...
			{
				_log.log(Level.SEVERE, "Could not delete augmentation for item: " + _item.getObjectId() + " from DB:", e1);
			}
			finally
			{
				try
