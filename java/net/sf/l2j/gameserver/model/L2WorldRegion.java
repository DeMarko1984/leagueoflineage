...
public final class L2WorldRegion
{
	...
	private final HashMap<Integer, L2PlayableInstance> _allPlayable;
	private final Object _lockPlayableObject = new Object();
	
	/** L2ObjectHashSet(L2Object) containing L2Object visible in this L2WorldRegion */
	private final HashMap<Integer, L2Object> _visibleObjects;
	private final Object _lockObject = new Object();
	
	private final ArrayList<L2WorldRegion> _surroundingRegions;
	...
	{
		_allPlayable = new HashMap<>(Config.MAXIMUM_ONLINE_USERS * 2); // new L2ObjectHashSet<L2PcInstance>();
		_visibleObjects = new HashMap<>(); // new L2ObjectHashSet<L2Object>();
	...
	private void switchAI(Boolean isOn)
	{
		...
		if (!isOn)
		{
			L2Object[] values = getVisibleObjects();
			for (L2Object o : values)
			{
	...
	public void addVisibleObject(L2Object object)
	{
		...
		{
			synchronized (_lockPlayableObject)
			{
	...
	/**
	 * Return the FastTable _surroundingRegions containing all L2WorldRegion around the current L2WorldRegion
	 * @return
	 */
	...
	{
		Iterator<L2PlayableInstance> iterator;
		synchronized (_lockPlayableObject)
		{
			iterator = _allPlayable.values().iterator();
		}
		return iterator;
	}
	 ...
	 * @return
	 */
	public final L2Object[] getVisibleObjects()
	{
		L2Object[] _toReturn = new L2Object[0];
		synchronized (_lockObject)
		{
			Collection<L2Object> _objects = _visibleObjects.values();
			ArrayList<L2Object> tmp = new ArrayList<>(_objects.size());
