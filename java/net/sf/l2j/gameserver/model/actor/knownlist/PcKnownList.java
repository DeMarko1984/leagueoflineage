...
public class PcKnownList extends PlayableKnownList
{
		...
		else
		{
			...
			else if (object instanceof L2PcInstance)
			{
				...
				if (otherPlayer.isInBoat())
				{
					...
					if ((otherPlayer.getKnownList().getKnownRelations().get(activeChar.getObjectId()) != null)
						&& (otherPlayer.getKnownList().getKnownRelations().get(activeChar.getObjectId()) != relation))
					{
	...
	public int getDistanceToForgetObject(L2Object object)
	{
		...
		int knownlistSize = getKnownObjectsSize();
		if (knownlistSize <= 25)
		{
			return 4200;
		}
