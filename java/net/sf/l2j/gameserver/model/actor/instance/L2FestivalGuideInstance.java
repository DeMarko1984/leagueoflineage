...
public final class L2FestivalGuideInstance extends L2FolkInstance
{
			...
			switch (val)
			{
				...
				case 4: // Current High Scores
					...
					if (overallScore > 0)
					{
						...
						strBuffer
							.append(
								"Consecutive top scores: " + calculateDate(overallData.getString("date")) + ". Score " + overallScore + "<br>Affilated side: " + cabalStr + "<br>"
	...
	private final String getStatsTable()
	{
		...
		for (int i = 0; i < 5; i++)
		{
			...
			tableHtml
				.append(
					"<tr><td width=\"100\" align=\"center\">" + festivalName + "</td><td align=\"center\" width=\"35\">" + duskScore + "</td><td align=\"center\" width=\"35\">" + dawnScore
