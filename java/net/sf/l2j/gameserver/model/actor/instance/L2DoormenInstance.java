	...
	public void showMessageWindow(L2PcInstance player)
	{
		...
		if (getClanHall() != null)
		{
			if (condition == COND_HALL_OWNER)
			{
				...
				str +=
					"<center><table><tr><td><button value=\"Open Door\" action=\"bypass -h npc_%objectId%_open_doors\" width=70 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"><br1></td></tr></table><br>";
				str +=
					"<table><tr><td><button value=\"Close Door\" action=\"bypass -h npc_%objectId%_close_doors\" width=70 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td></tr></table></center></body></html>";
			}
			else
			{
