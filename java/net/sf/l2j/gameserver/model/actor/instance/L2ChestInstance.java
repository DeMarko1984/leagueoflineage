...
public final class L2ChestInstance extends L2MonsterInstance
{
	...
	public void doItemDrop(L2NpcTemplate npcTemplate, L2Character lastAttacker)
	{
		...
		if (_specialDrop && (lastAttacker instanceof L2PcInstance))
		{
			int adenaCoutn = Rnd.get(this.getLevel() * 10, this.getLevel() * 100);
			if (Config.AUTO_LOOT)
			{
				((L2PcInstance) lastAttacker).addAdena("Loot", adenaCoutn, this, true);
			}
			else
			{
				DropItem((L2PcInstance) lastAttacker, 57, adenaCoutn);
			}
		}
