...
public class PetStat extends SummonStat
{
	...
	public int getMaxHp()
	{
		return (int) (calcStat(Stats.MAX_HP, getActiveChar().getPetData().getPetMaxHP(), null, null) * getAddModificator("con"));
	}
	
	@Override
	public int getMaxMp()
	{
		return (int) (calcStat(Stats.MAX_MP, getActiveChar().getPetData().getPetMaxMP(), null, null) * getAddModificator("men"));
	}
	...
	public int getMAtk(L2Character target, L2Skill skill)
	{
		...
		return (int) (calcStat(Stats.MAGIC_ATTACK, attack, target, skill) * getAddModificator("int"));
	}
	...
	public int getMDef(L2Character target, L2Skill skill)
	{
		...
		return (int) (calcStat(Stats.MAGIC_DEFENCE, defence, target, skill) * getAddModificator("men"));
	}
	
	@Override
	public int getPAtk(L2Character target)
	{
		return (int) (calcStat(Stats.POWER_ATTACK, getActiveChar().getPetData().getPetPAtk(), target, null) * getAddModificator("str"));
	}
	
	@Override
	public int getPDef(L2Character target)
	{
		return (int) (calcStat(Stats.POWER_DEFENCE, getActiveChar().getPetData().getPetPDef(), target, null) * getAddModificator("con"));
	}
	
	@Override
	public int getAccuracy()
	{
		return (int) (calcStat(Stats.ACCURACY_COMBAT, getActiveChar().getPetData().getPetAccuracy(), null, null) * getAddModificator("dex"));
	}
	
	@Override
	public int getCriticalHit(L2Character target, L2Skill skill)
	{
		return (int) (calcStat(Stats.CRITICAL_RATE, getActiveChar().getPetData().getPetCritical(), target, null) * getAddModificator("dex"));
	}
	
	@Override
	public int getEvasionRate(L2Character target)
	{
		return (int) (calcStat(Stats.EVASION_RATE, getActiveChar().getPetData().getPetEvasion(), target, null) * getAddModificator("dex"));
	}
	
	@Override
	public int getRunSpeed()
	{
		return (int) (calcStat(Stats.RUN_SPEED, getActiveChar().getPetData().getPetSpeed(), null, null) * getAddModificator("dex"));
	}
	
	@Override
	public int getPAtkSpd()
	{
		return (int) (calcStat(Stats.POWER_ATTACK_SPEED, getActiveChar().getPetData().getPetAtkSpeed(), null, null) * getAddModificator("dex"));
	}
	
	@Override
	public int getMAtkSpd()
	{
		return (int) (calcStat(Stats.MAGIC_ATTACK_SPEED, getActiveChar().getPetData().getPetCastSpeed(), null, null) * getAddModificator("wit"));
	}
}
