...
public final class L2Weapon extends L2Item
{
	...
	public Func[] getStatFuncs(L2ItemInstance instance, L2Character player)
	{
		...
		if (_funcTemplates != null)
		{
			for (FuncTemplate t : _funcTemplates)
			{
				...
				env.item = new WeakReference<>(instance);
	...
	public L2Effect[] getSkillEffects(L2Character caster, L2Character target, boolean crit)
	{
		...
		{
			if (target.isRaid() && ((skill.getSkillType() == SkillType.CONFUSION) || (skill.getSkillType() == SkillType.MUTE) || (skill.getSkillType() == SkillType.PARALYZE)
