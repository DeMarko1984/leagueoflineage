...
public class RegionBBSManager extends BaseBBSManager
{
	...
	private void showOldCommunityPI(L2PcInstance activeChar, String name)
	{
		...
		if (player != null)
		{
			...
			htmlCode
				.append(
					"<tr><td><multiedit var=\"pm\" width=240 height=40><button value=\"Send PM\" action=\"Write Region PM " + player.getName()
	...
	private static Map<Integer, ArrayList<L2PcInstance>> _onlinePlayers = new HashMap<>();
	private static Map<Integer, HashMap<String, String>> _communityPages = new HashMap<>();
	...
	private void writeCommunityPages()
	{
		for (int page : _onlinePlayers.keySet())
		{
			...
			if (getOnlineCount("gm") > Config.NAME_PAGE_SIZE_COMMUNITYBOARD)
			{
				...
				{
					htmlCode
						.append("<td align=right width=190><button value=\"Prev\" action=\"bypass _bbsloc;page;" + (page - 1) + "\" width=50 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td>");
				}
				htmlCode.append("<td FIXWIDTH=10></td>");
				htmlCode
					.append(
						"<td align=center valign=top width=200>Displaying " + (((page - 1) * Config.NAME_PAGE_SIZE_COMMUNITYBOARD) + 1) + " - "
			...
			_communityPages.put(page, (HashMap<String, String>) communityPage);
		}
	}
