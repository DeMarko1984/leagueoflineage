...
public class MinionList
{
	...
	protected HashMap<Long, Integer> _respawnTasks = new HashMap<>();
	...
	public void spawnSingleMinion(int minionid)
	{
		...
		if (Config.DEBUG)
		{
			_log
				.fine(
					"Spawned minion template " + minionTemplate.npcId + " with objid: " + monster.getObjectId() + " to boss " + master.getObjectId() + " ,at: " + monster.getX() + " x, "
