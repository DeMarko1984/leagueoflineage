...
public final class Broadcast
{
	...
	public static void toPlayersTargettingMyself(L2Character character, L2GameServerPacket mov)
	{
		if (Config.DEBUG)
		{
			_log.fine("players to notify:" + character.getKnownList().getKnownPlayersArray().length + " packet:" + mov.getType());
		}
		
		for (L2PcInstance player : character.getKnownList().getKnownPlayersArray())
		{
