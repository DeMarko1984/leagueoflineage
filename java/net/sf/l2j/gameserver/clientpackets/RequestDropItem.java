...
public final class RequestDropItem extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (!item.isStackable() && (_count > 1))
		{
			Util
				.handleIllegalPlayerAction(
					activeChar,
						"[RequestDropItem] count > 1 but item is not stackable! ban! oid: " + _objectId + " owner: " + activeChar.getName(),
		...
		try
		{
			dropedItem = activeChar.dropItem("Drop", _objectId, _count, _x, _y, _z, null, true);
			if (activeChar.isGM())
			{
