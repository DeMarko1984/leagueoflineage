...
public final class ChangeWaitType2 extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if ((target != null) && !player.isSitting() && (target instanceof L2StaticObjectInstance) && (((L2StaticObjectInstance) target).getType() == 1)
			&& (CastleManager.getInstance().getCastle(target) != null) && player.isInsideRadius(target, L2StaticObjectInstance.INTERACTION_DISTANCE, false, false))
		{
