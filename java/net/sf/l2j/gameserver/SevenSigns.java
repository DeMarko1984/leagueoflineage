...
public class SevenSigns
{
	...
	protected void restoreSevenSignsData()
	{
			...
			ResultSet rs1 = ps1.executeQuery())
		{
			...
			try (
				PreparedStatement ps2 = con.prepareStatement("SELECT * FROM seven_signs_status WHERE id=0");
			...
			try (
				PreparedStatement ps3 = con.prepareStatement("UPDATE seven_signs_status SET date=? WHERE id=0"))
			{
	...
	public void saveSevenSignsData(L2PcInstance player, boolean updateSettings)
	{
		...
		try
		{
			...
			{
				String sqlQuery =
					"UPDATE seven_signs_status SET current_cycle=?, active_period=?, previous_winner=?, " + "dawn_stone_score=?, dawn_festival_score=?, dusk_stone_score=?, dusk_festival_score=?, "
