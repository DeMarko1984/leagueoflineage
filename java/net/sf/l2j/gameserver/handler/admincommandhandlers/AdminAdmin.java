...
public class AdminAdmin implements IAdminCommandHandler
{
	...
	public boolean useAdminCommand(String command, L2PcInstance activeChar)
	{
		...
		else if (command.startsWith("admin_reinit_formulas"))
		{
			Config.FORMULAS_CONFIG = null;
			Formulas.ComputeBaseStats();
			activeChar.sendMessage("Formulas reloaded!");
