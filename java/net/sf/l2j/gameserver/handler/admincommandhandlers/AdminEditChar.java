...
public class AdminEditChar implements IAdminCommandHandler
{
	...
	private void listCharacters(L2PcInstance activeChar, int page)
	{
		...
		{ // Add player info into new Table row
			replyMSG
				.append(
					"<tr><td width=80><a action=\"bypass -h admin_character_info " + players[i].getName() + "\">" + players[i].getName() + "</a></td><td width=110>"
						+ players[i].getTemplate().className + "</td><td width=40>" + players[i].getLevel() + "</td></tr>");
		}
	...
	private void adminModifyCharacter(L2PcInstance activeChar, String modifications)
	{
		...
		if (Config.DEBUG)
		{
			_log
				.fine(
					"[GM]" + activeChar.getName() + " changed stats of " + player.getName() + ". " + " HP: " + hpval + " MP: " + mpval + " CP: " + cpval + " PvP: " + pvpflagval + " / " + pvpkillsval);
		}
	...
	private void findCharacter(L2PcInstance activeChar, String CharacterToFind)
	{
		...
		{ // Add player info into new Table row
			...
			if (name.toLowerCase().contains(CharacterToFind.toLowerCase()))
			{
				...
				replyMSG
					.append(
						"<tr><td width=80><a action=\"bypass -h admin_character_list " + name + "\">" + name + "</a></td><td width=110>" + player.getTemplate().className + "</td><td width=40>"
