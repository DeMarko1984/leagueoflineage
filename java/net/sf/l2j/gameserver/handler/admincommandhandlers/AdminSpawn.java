...
public class AdminSpawn implements IAdminCommandHandler
{
	...
	private void showMonsters(L2PcInstance activeChar, int level, int from)
	{
		...
		String end1 =
			"<br><center><button value=\"Next\" action=\"bypass -h admin_spawn_index " + level + " $from$\" width=40 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></center></body></html>";
	...
	private void showNpcs(L2PcInstance activeChar, String starting, int from)
	{
		...
		String end1 =
			"<br><center><button value=\"Next\" action=\"bypass -h admin_npc_index " + starting + " $from$\" width=40 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></center></body></html>";
