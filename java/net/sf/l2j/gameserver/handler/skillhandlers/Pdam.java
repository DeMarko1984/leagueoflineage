...
public class Pdam implements ISkillHandler
{
	...
	public void useSkill(L2Character activeChar, L2Skill skill, L2Object[] targets)
	{
		...
		for (L2Object target2 : targets)
		{
			...
			{
				crit = f.calcCrit(activeChar, skill.getBaseCritRate() * 10 * f.getSTRBonus(activeChar), true);
			}
			...
			if ((damage > 5000) && (activeChar instanceof L2PcInstance))
			{
				...
				Log
					.add(
						activeChar.getName() + "(" + activeChar.getObjectId() + ") " + activeChar.getLevel() + " lvl did damage " + damage + " with skill " + skill.getName() + "(" + skill.getId()
							+ ") to " + name,
							"damage_pdam");
			}
			...
			if (damage > 0)
			{
				...
				if (!target.isRaid() && (chance < skill.getLethalChance1()) && !(target instanceof L2DoorInstance)
