				...
				case NEGATE:
				{
					...
					if (skill.getId() == 1056)
					{
						...
						if (Rnd.get(100) < landrate)
						{
							...
							for (L2Effect e : effects)
							{
								if ((e.getSkill().getId() != 4082) && (e.getSkill().getId() != 4215) && (e.getSkill().getId() != 4515) && (e.getSkill().getId() != 110) && (e.getSkill().getId() != 111)
									&& (e.getSkill().getId() != 1323) && (e.getSkill().getId() != 1325)) // Cannot cancel skills 4082,
																											// 4215, 4515, 110, 111,
																											// 1323, 1325
								{
