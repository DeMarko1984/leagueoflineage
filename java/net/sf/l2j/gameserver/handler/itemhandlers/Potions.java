...
public class Potions implements IItemHandler
{
	...
	public synchronized void useItem(L2PlayableInstance playable, L2ItemInstance item)
	{
		...
		switch (itemId)
		{
			...
			case 8627:
				// elixir of Life
				if (((itemId == 8622) && (activeChar.getExpertiseIndex() == 0)) || ((itemId == 8623) && (activeChar.getExpertiseIndex() == 1))
					|| ((itemId == 8624) && (activeChar.getExpertiseIndex() == 2)) || ((itemId == 8625) && (activeChar.getExpertiseIndex() == 3))
			...
			case 8633:
				// elixir of Strength
				if (((itemId == 8628) && (activeChar.getExpertiseIndex() == 0)) || ((itemId == 8629) && (activeChar.getExpertiseIndex() == 1))
					|| ((itemId == 8630) && (activeChar.getExpertiseIndex() == 2)) || ((itemId == 8631) && (activeChar.getExpertiseIndex() == 3))
			...
			case 8639:
				// elixir of cp
				if (((itemId == 8634) && (activeChar.getExpertiseIndex() == 0)) || ((itemId == 8635) && (activeChar.getExpertiseIndex() == 1))
					|| ((itemId == 8636) && (activeChar.getExpertiseIndex() == 2)) || ((itemId == 8637) && (activeChar.getExpertiseIndex() == 3))
