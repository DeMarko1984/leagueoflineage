...
public class Wedding implements IVoicedCommandHandler
{
	...
	public boolean GoToLove(L2PcInstance activeChar)
	{
		...
		else if ((partner.getClan() != null) && (CastleManager.getInstance().getCastleByOwner(partner.getClan()) != null)
		...
		else if ((activeChar.getClan() != null) && (CastleManager.getInstance().getCastleByOwner(activeChar.getClan()) != null)
		...
		// Thanks nbd
		else if (activeChar.isInLgeEvent() && !LgeManager.getInstance().onEscapeUse(activeChar.getName()))
		{
