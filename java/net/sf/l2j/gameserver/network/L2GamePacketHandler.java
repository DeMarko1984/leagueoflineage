...
import net.sf.l2j.mmocore.network.IClientFactory;
import net.sf.l2j.mmocore.network.IMMOExecutor;
import net.sf.l2j.mmocore.network.IPacketHandler;
import net.sf.l2j.mmocore.network.MMOConnection;
...
public final class L2GamePacketHandler implements IPacketHandler<L2GameClient>, IClientFactory<L2GameClient>, IMMOExecutor<L2GameClient>
{
	...
	public ReceivablePacket<L2GameClient> handlePacket(ByteBuffer buf, L2GameClient client)
	{
		...
		if (msg != null)
		{
			_log.warning(msg.toString() + " Client: " + client.toString());
		}
		else
		{
			_log.warning(Integer.toHexString(opcode) + " Client: " + client.toString());
		}
