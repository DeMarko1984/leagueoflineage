...
import net.sf.l2j.gameserver.handler.itemhandlers.ChestKey2;
...
import net.sf.l2j.gameserver.handler.skillhandlers.ItemKey;
...
public class GameServer
{
	...
	public GameServer() throws Exception
	{
		...
		_itemHandler.registerItemHandler(new ChestKey2());
		...
		_skillHandler.registerSkillHandler(new ItemKey());
		...
		_log.config("Start Idle connections update task every 30 seconds.");
		ThreadPoolManager.getInstance().scheduleGeneralAtFixedRate(new IdleConnectionsUpdateTask(), 30 * 1000, 30 * 1000);
	}
