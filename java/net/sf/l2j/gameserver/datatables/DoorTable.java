...
public class DoorTable
{
	...
	public boolean checkIfDoorsBetween(Node geoPath, Node geoPath2)
	{
		return checkIfDoorsBetween(geoPath.getX(), geoPath.getY(), geoPath.getZ(), geoPath2.getX(), geoPath2.getY(), geoPath2.getZ(), 0, true);
	}
	
	public boolean checkIfDoorsBetween(int x, int y, int z, int tx, int ty, int tz, int instanceId, boolean playable)
	{
		int region;
		try
		{
