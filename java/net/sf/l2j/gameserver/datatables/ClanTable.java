...
public class ClanTable
{
	...
	public L2Clan createClan(L2PcInstance player, String clanName)
	{
		...
		L2ClanMember leader =
			new L2ClanMember(clan, player.getName(), player.getLevel(), player.getClassId().getId(), player.getObjectId(), player.getPledgeType(), player.getPowerGrade(), player.getTitle());
