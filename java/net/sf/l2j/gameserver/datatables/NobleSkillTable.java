...
public class NobleSkillTable
{
	...
	private NobleSkillTable()
	{
		...
		_nobleSkills[2] = SkillTable.getInstance().getInfo(1324, 1);
		// _nobleSkills[4] = SkillTable.getInstance().getInfo(1325, 1);
		_nobleSkills[3] = SkillTable.getInstance().getInfo(1326, 1);
		_nobleSkills[4] = SkillTable.getInstance().getInfo(1327, 1);
	}
