...
import net.sf.l2j.gameserver.model.zone.type.L2NoLeaveZone;
import net.sf.l2j.gameserver.model.zone.type.L2OlympiadStadiumZone;
import net.sf.l2j.gameserver.model.zone.type.L2OnlyInstanceZone;
				...
				if ("list".equalsIgnoreCase(n.getNodeName()))
				{
					for (Node d = n.getFirstChild(); d != null; d = d.getNextSibling())
					{
						if ("zone".equalsIgnoreCase(d.getNodeName()))
						{
							...
							else if (zoneType.equals("NoLeaveZone"))
							{
								temp = new L2NoLeaveZone();
							}
							else if (zoneType.equals("OnlyInstanceZone"))
							{
								temp = new L2OnlyInstanceZone();
							}
