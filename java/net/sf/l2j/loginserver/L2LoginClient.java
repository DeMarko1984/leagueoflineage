...
import net.sf.l2j.mmocore.network.MMOClient;
import net.sf.l2j.mmocore.network.MMOConnection;
import net.sf.l2j.mmocore.network.SendablePacket;
...
public final class L2LoginClient extends MMOClient<MMOConnection<L2LoginClient>>
{
	...
	/**
	 * @see net.sf.l2j.mmocore.network.MMOClient#onDisconnection()
	 */
	@Override
	...
	/**
	 * @see net.sf.l2j.mmocore.network.MMOClient#onForcedDisconnection()
	 */
	@Override
